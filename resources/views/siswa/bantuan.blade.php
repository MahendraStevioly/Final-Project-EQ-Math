        ...
        <div class="bg-white rounded-2xl shadow-sm p-6 border border-slate-200">
            ...
            <div class="space-y-4">
                ...
                <div class="border border-slate-200 rounded-xl">
                    ...
                    <div class="hidden p-4 pt-0 text-slate-600 text-sm">
                        Kami menerima pembayaran melalui transfer bank (BCA, Mandiri), e-wallet (GoPay, OVO), QRIS, dan pembayaran di minimarket terdekat via Midtrans.
                    </div>
                </div>
                ...
                <div class="border border-slate-200 rounded-xl">
                    ...
                    <div class="hidden p-4 pt-0 text-slate-600 text-sm">
                        Jika pembayaran gagal, silakan coba lagi dari menu pembayaran atau hubungi customer service kami melalui WhatsApp untuk bantuan lebih lanjut.
                    </div>
                </div>
    ...
    <div class="space-y-6">
        ...
        <div class="bg-white rounded-2xl shadow-sm p-6 border border-slate-200">
            ...
            <div class="space-y-3 text-sm">
                ...
                <div class="flex items-center space-x-3">
                    <i class="fab fa-instagram text-blue-600 w-5"></i>
        ...
        <div class="bg-white rounded-2xl shadow-sm p-6 border border-slate-200">
            ...
            <div class="space-y-3 text-sm">
                <p class="text-slate-600">
                    <i class="fas fa-map-marker-alt text-blue-600 w-5 mr-2"></i>
