...
<div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-slate-200">
        ...
        <form action="{{ route('admin.pengaturan.profile') }}" method="POST" class="p-6 space-y-4">
            @csrf
            <div>
            ...
            <div class="flex space-x-3 pt-4">
                <button type="submit" class="flex-1 px-6 py-3 bg-blue-600 text-white rounded-xl hover:bg-blue-700 transition font-medium">
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-slate-200">
        ...
        <form action="{{ route('admin.pengaturan.password') }}" method="POST" class="p-6 space-y-4">
            @csrf
            <div>
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-slate-200">
        ...
        <div class="p-6 space-y-4">
            ...
            <div class="flex items-center justify-between py-3 border-b border-slate-100">
                ...
                <span class="font-semibold text-slate-900">{{ phpversion() }}</span>
            </div>
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-slate-200">
        ...
        <div class="p-6 space-y-3">
            <a href="{{ route('admin.pengajar.index') }}" class="flex items-center justify-between p-4 bg-slate-50 rounded-xl hover:bg-slate-100 transition">
            ...
            <a href="{{ route('admin.kelas.index') }}" class="flex items-center justify-between p-4 bg-slate-50 rounded-xl hover:bg-slate-100 transition">
                <div class="flex items-center space-x-3">
            ...
            <a href="{{ route('admin.jadwal.index') }}" class="flex items-center justify-between p-4 bg-slate-50 rounded-xl hover:bg-slate-100 transition">
                <div class="flex items-center space-x-3">
            ...
            <a href="#" onclick="event.preventDefault(); document.getElementById('logout-form-quick').submit();" class="flex items-center justify-between p-4 bg-red-50 rounded-xl hover:bg-red-100 transition">
                <div class="flex items-center space-x-3">
            ...
            <form id="logout-form-quick" action="{{ route('logout') }}" method="POST" class="hidden">
                @csrf
            </form>
        </div>
    </div>
...
<script>
    ...
    document.querySelector('form input[name="new_password_confirmation"]').addEventListener('input', function() {
